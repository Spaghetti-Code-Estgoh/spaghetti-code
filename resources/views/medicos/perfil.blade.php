            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card card-registo middle">
                        <div class="card-header mx-auto" style="padding-top: 5rem">{{ __('Alterar Perfil') }}</div>

                        <div class="card-body" style="padding-top: 2rem">
                            <form method="POST" action="{{ route('alterarMedico') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="esp" type="text" class="form-control @error('esp') is-invalid @enderror" name="esp" value="{{ old('esp') }}" required autocomplete="esp" placeholder="{{session('especialidade')}}">
                                        @error('esp')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong></span>
                                        @enderror
